...
mod tests {
    ...
    fn test_get_or_create_application() {
        ...
        let app1 = db
            .get_or_create_application("com.apple.safari", "Safari")
            .unwrap();
        ...
        let app3 = db
            .get_or_create_application("com.google.chrome", "Chrome")
            .unwrap();
    ...
    fn test_session_lifecycle() {
        ...
        let app = db
            .get_or_create_application("com.test.app", "Test App")
            .unwrap();
    ...
    fn test_top_apps() {
        ...
        let app1 = db
            .get_or_create_application("com.test.app1", "App 1")
            .unwrap();
        let app2 = db
            .get_or_create_application("com.test.app2", "App 2")
            .unwrap();
